...
export default function App() {
  ...
  return (
    <div className=" min-h-screen p-8 font-sans">
      <h1 className="text-9xl md:text-6xl font-extrabold text-center mb-12 text-black">
        Manga News Central
      </h1>
      <div className="max-w-5xl mx-auto">
        <div className="flex justify-center items-center">
          <button
            ...
            className="w-full md:w-auto mb-8 bg-black hover:bg-black text-white font-bold py-3 px-6 rounded-lg shadow-lg transition transform hover:scale-105"
          >
            New Manga News
          </button>
        </div>
